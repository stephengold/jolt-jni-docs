...
tasks.register<JavaExec>("HelloServo") {
    args("jython", "scripts/sport/tutorial/hello_servo.py",
         "../class-lists/jolt-jni-classes.txt",
         "../class-lists/sport-jolt-classes.txt")
    description = "Runs the Jython port of the HelloServo tutorial app."
}
...
tasks.register<JavaExec>("HelloSoftRope") {
    args("jython", "scripts/sport/tutorial/hello_soft_rope.py",
         "../class-lists/jolt-jni-classes.txt",
         "../class-lists/sport-jolt-classes.txt")
    description = "Runs the Jython port of the HelloSoftRope tutorial app."
}
...
tasks.register<JavaExec>("HelloSpring") {
    args("jython", "scripts/sport/tutorial/hello_spring.py",
         "../class-lists/jolt-jni-classes.txt",
         "../class-lists/sport-jolt-classes.txt")
    description = "Runs the Jython port of the HelloSpring tutorial app."
}
