...
tasks.register<JavaExec>("HelloPin") {
    description = "Runs the Scala port of the HelloPin tutorial app."
    mainClass = "com.github.stephengold.sportjolt.scala.tutorial.HelloPin"
}
...
tasks.register<JavaExec>("HelloServo") {
    description = "Runs the Scala port of the HelloServo tutorial app."
    mainClass = "com.github.stephengold.sportjolt.scala.tutorial.HelloServo"
}
...
tasks.register<JavaExec>("HelloSoftRope") {
    description = "Runs the Scala port of the HelloSoftRope tutorial app."
    mainClass = "com.github.stephengold.sportjolt.scala.tutorial.HelloSoftRope"
}
...
tasks.register<JavaExec>("HelloVehicle") {
    description = "Runs the Scala port of the HelloVehicle tutorial app."
    mainClass = "com.github.stephengold.sportjolt.scala.tutorial.HelloVehicle"
}
