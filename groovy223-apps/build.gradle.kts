// Gradle script to build and run the "groovy223-apps" subproject of jolt-jni-docs
...
tasks.register<JavaExec>("HelloJoltJni") {
    args("groovy", "scripts/console/HelloJoltJni.groovy")
...
tasks.register<JavaExec>("HelloRigidBody") {
    args("groovy", "scripts/sport/tutorial/HelloRigidBody.groovy")
    description = "Runs the Groovy port of the HelloRigidBody tutorial app."
}
tasks.register<JavaExec>("HelloSport") {
    args("groovy", "scripts/sport/tutorial/HelloSport.groovy")
