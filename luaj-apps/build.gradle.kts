// Gradle script to build and run the "luaj-apps" subproject of jolt-jni-docs
...
tasks.register<JavaExec>("HelloJoltJni") {
    args("luaj", "scripts/console/HelloJoltJni.lua",
         "../class-lists/jolt-jni-classes.txt",
         "../class-lists/snap-loader-classes.txt")
    description = "Runs the LuaJ port of the HelloJoltJni console app."
}
