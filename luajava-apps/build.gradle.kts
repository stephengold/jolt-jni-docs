// Gradle script to build and run the "luajava-apps" subproject of jolt-jni-docs
...
dependencies {
    ...
    runtimeOnly(libs.luajava.base)
    runtimeOnly(libs.luajava.jsr223)
    runtimeOnly(libs.luajava.lua54)
    runtimeOnly(variantOf(libs.luajava.lua54.platform){classifier("natives-desktop")})
