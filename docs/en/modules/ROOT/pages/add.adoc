...
dependencies {
    // JVM library:
    implementation("com.github.stephengold:jolt-jni-Windows64:3.0.1")

    // native libraries:
    runtimeOnly("com.github.stephengold:jolt-jni-Linux64:3.0.1:DebugSp")
...
Similarly, {JPH} allows custom callbacks
