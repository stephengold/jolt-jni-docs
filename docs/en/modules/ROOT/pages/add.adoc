...
dependencies {
    // JVM library:
    implementation("com.github.stephengold:jolt-jni-Windows64:4.0.1")

    // native libraries:
    runtimeOnly("com.github.stephengold:jolt-jni-Linux64:4.0.1:DebugSp")
...
dependencies {
    ...
    runtimeOnly("com.github.oshi:oshi-core:6.11.0")
}
----
