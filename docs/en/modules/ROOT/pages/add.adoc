...
dependencies {
    // JVM library:
    implementation("com.github.stephengold:jolt-jni-Windows64:3.10.0")

    // native libraries:
    runtimeOnly("com.github.stephengold:jolt-jni-Linux64:3.10.0:DebugSp")
...
dependencies {
    ...
    runtimeOnly("com.github.oshi:oshi-core:6.10.0")
}
----
