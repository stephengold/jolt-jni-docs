...
dependencies {
    // JVM library:
    implementation("com.github.stephengold:jolt-jni-Windows64:4.2.0")

    // native libraries:
    runtimeOnly("com.github.stephengold:jolt-jni-Linux64:4.2.0:DebugSp")
...
dependencies {
    ...
    runtimeOnly("com.github.oshi:oshi-core:7.0.0")
}
----
