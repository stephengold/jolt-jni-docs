...
dependencies {
    // JVM library:
    implementation("com.github.stephengold:jolt-jni-Windows64:5.0.0")

    // native libraries:
    runtimeOnly("com.github.stephengold:jolt-jni-Linux64:5.0.0:DebugSp")
...
dependencies {
    ...
    runtimeOnly("com.github.oshi:oshi-core:7.1.0")
}
----
