...
.. a https://adoptium.net/temurin/releases/[Java Development Kit (JDK)],
  version 21 or higher, and
.. one of the supported {Cplusplus} compilers:
... for Linux:  https://gcc.gnu.org[the GNU Compiler Collection (GCC)] or https://www.llvm.org[Clang]
...
After a successful build,
Android library artifacts will be found in "build/outputs/aar".
...
. Install Antora: `npm i -D -E @antora/cli@3.2`
