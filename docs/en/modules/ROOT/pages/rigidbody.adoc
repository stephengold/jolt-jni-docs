...
{url-tutorial}/HelloRigidBody.java[HelloRigidBody] is a Sport-Jolt app
...
{url-tutorial}/HelloStaticBody.java[HelloStaticBody] is a Sport-Jolt app
...
. In Sport-Jolt, dynamic rigid bodies are conventionally colored magenta,
...
{url-tutorial}/HelloKinematics.java[HelloKinematics] is a Sport-Jolt app
...
* `Body.addImpulse(Vec3Arg force, RVec3Arg location)`
...
{url-tutorial}/HelloDamping.java[HelloDamping] is a Sport-Jolt app
...
In Jolt Physics, collisions are inelastic by default.
...
{url-tutorial}/HelloDeactivation.java[HelloDeactivation] is a Sport-Jolt app
...
{url-tutorial}/HelloCcd.java[HelloCcd] is a Sport-Jolt app
...
* Continuous collision detection (CCD) solves the problem
  of fast-moving bodies passing through thin obstacles.
