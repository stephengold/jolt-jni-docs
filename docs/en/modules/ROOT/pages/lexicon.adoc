...
between {JPHAdj} names and {ProjectAdj} names.
...
{Project} has a different notion of camel case than {JPH} does:
...
|{url-api}/BodyLockInterface.html[BodyLockInterface] +
 {url-api}/readonly/ConstBodyLockInterface.html[ConstBodyLockInterface]
...
|{url-api}/BodyLockInterfaceLocking.html[BodyLockInterfaceLocking] +
 {url-api}/readonly/ConstBodyLockInterfaceLocking.html[ConstBodyLockInterfaceLocking]
...
|{url-api}/BodyLockInterfaceNoLock.html[BodyLockInterfaceNoLock] +
 {url-api}/readonly/ConstBodyLockInterfaceNoLock.html[ConstBodyLockInterfaceNoLock]

|{url-jolt}body_lock_multi_base.html[JPH::BodyLockMultiBase]
|{url-api}/BodyLockMultiBase.html[BodyLockMultiBase]

|{url-jolt}body_lock_multi_read.html[JPH::BodyLockMultiRead]
|{url-api}/BodyLockMultiRead.html[BodyLockMultiRead]

|{url-jolt}body_lock_multi_write.html[JPH::BodyLockMultiWrite]
|{url-api}/BodyLockMultiWrite.html[BodyLockMultiWrite]
...
|{url-api}/BroadPhaseQuery.html[BroadPhaseQuery] +
 {url-api}/readonly/ConstBroadPhaseQuery.html[ConstBroadPhaseQuery]
...
|{url-jolt}character_contact.html[JPH::CharacterContact]
|{url-api}/CharacterContact.html[CharacterContact] +
 {url-api}/readonly/ConstCharacterContact.html[ConstCharacterContact]

|{url-jolt}character_contact_key.html[JPH::CharacterContactKey]
|{url-api}/CharacterContactKey.html[CharacterContactKey] +
 {url-api}/readonly/ConstCharacterContactKey.html[ConstCharacterContactKey]
...
|{url-api}/CollideSettingsBase.html[CollideSettingsBase] +
 {url-api}/readonly/ConstCollideSettingsBase.html[ConstCollideSettingsBase]
...
|{url-api}/CollideShapeSettings.html[CollideShapeSettings] +
 {url-api}/readonly/ConstCollideShapeSettings.html[ConstCollideShapeSettings]
...
|{url-jolt}compute_queue.html[JPH::ComputeQueue]
|{url-api}/ComputeQueue.html[ComputeQueue] +
 {url-api}/ComputeQueueRef.html[ComputeQueueRef]

|{url-jolt}compute_system.html[JPH::ComputeSystem]
|{url-api}/ComputeSystem.html[ComputeSystem] +
 {url-api}/ComputeSystemRef.html[ComputeSystemRef]
...
|{url-api}/ConvexShape.html[ConvexShape] +
 {url-api}/readonly/ConstConvexShape.html[ConstConvexShape]
...
|{url-jolt}debug_renderer_simple.html[JPH::DebugRendererSimple]
|{url-api}/DebugRendererSimple.html[DebugRendererSimple]
...
|{url-api}/Float3.html[Float3] +
 {url-api}/readonly/ConstFloat3.html[ConstFloat3]

|{url-jolt}float4.html[JPH::Float4]
|{url-api}/Float4.html[Float4] +
 {url-api}/readonly/ConstFloat4.html[ConstFloat4]
...
|{url-jolt}hair.html[JPH::Hair]
|{url-api}/Hair.html[Hair]

|{url-jolt}hair_settings.html[JPH::HairSettings]
|{url-api}/HairSettings.html[HairSettings] +
 {url-api}/readonly/ConstHairSettings.html[ConstHairSettings] +
 {url-api}/HairSettingsRef.html[HairSettingsRef]

|{url-jolt}hair_shaders.html[JPH::HairShaders]
|{url-api}/HairShaders.html[HairShaders] +
 {url-api}/HairShadersRef.html[HairShadersRef]
...
|{url-jolt}linear_curve.html[JPH::LinearCurve]
|{url-api}/LinearCurve.html[LinearCurve] +
 {url-api}/readonly/ConstLinearCurve.html[ConstLinearCurve]
...
|{url-api}/MotorSettings.html[MotorSettings] +
 {url-api}/readonly/ConstMotorSettings.html[ConstMotorSettings]
...
|{url-api}/MotorcycleControllerSettings.html[MotorcycleControllerSettings] +
 {url-api}/readonly/ConstMotorcycleControllerSettings.html[ConstMotorcycleControllerSettings]
...
|{url-api}/NarrowPhaseQuery.html[NarrowPhaseQuery] +
 {url-api}/readonly/ConstNarrowPhaseQuery.html[ConstNarrowPhaseQuery]
...
|{url-api}/PathConstraintPath.html[PathConstraintPath] +
 {url-api}/readonly/ConstPathConstraintPath.html[ConstPathConstraintPath] +
...
|{url-api}/PhysicsScene.html[PhysicsScene] +
 {url-api}/readonly/ConstPhysicsScene.html[ConstPhysicsScene] +
...
|{url-api}/PhysicsSystem.html[PhysicsSystem] +
 {url-api}/readonly/ConstPhysicsSystem.html[ConstPhysicsSystem]
...
|{url-api}/RayCastSettings.html[RayCastSettings] +
 {url-api}/readonly/ConstRayCastSettings.html[ConstRayCastSettings]
...
|{url-api}/ShapeCastSettings.html[ShapeCastSettings] +
 {url-api}/readonly/ConstShapeCastSettings.html[ConstShapeCastSettings]
...
|{url-api}/SkeletonPose.html[SkeletonPose] +
 {url-api}/readonly/ConstSkeletonPose.html[ConstSkeletonPose]
...
|{url-api}/TrackedVehicleControllerSettings.html[TrackedVehicleControllerSettings] +
 {url-api}/readonly/ConstTrackedVehicleControllerSettings.html[ConstTrackedVehicleControllerSettings]
...
|{url-api}/VehicleCollisionTester.html[VehicleCollisionTester] +
 {url-api}/readonly/ConstVehicleCollisionTester.html[ConstVehicleCollisionTester] +
...
|{url-api}/VehicleConstraint.html[VehicleConstraint] +
 {url-api}/readonly/ConstVehicleConstraint.html[ConstVehicleConstraint] +
...
|{url-api}/VehicleConstraintSettings.html[VehicleConstraintSettings] +
 ...
 {url-api}/VehicleConstraintSettingsRef.html[VehicleConstraintSettingsRef]

|{url-jolt}vehicle_controller.html[JPH::VehicleController]
|{url-api}/VehicleController.html[VehicleController] +
 {url-api}/readonly/ConstVehicleController.html[ConstVehicleController]
...
|{url-api}/VehicleDifferentialSettings.html[VehicleDifferentialSettings] +
 {url-api}/readonly/ConstVehicleDifferentialSettings.html[ConstVehicleDifferentialSettings]
...
|{url-api}/VehicleEngineSettings.html[VehicleEngineSettings] +
 {url-api}/readonly/ConstVehicleEngineSettings.html[ConstVehicleEngineSettings]

|{url-jolt}vehicle_track_settings.html[JPH::VehicleTrackSettings]
|{url-api}/VehicleTrackSettings.html[VehicleTrackSettings] +
 {url-api}/readonly/ConstVehicleTrackSettings.html[ConstVehicleTrackSettings]
...
|{url-api}/VehicleTransmissionSettings.html[VehicleTransmissionSettings] +
 {url-api}/readonly/ConstVehicleTransmissionSettings.html[ConstVehicleTransmissionSettings]

|{url-jolt}wheel.html[JPH::Wheel]
|{url-api}/Wheel.html[Wheel] +
 {url-api}/readonly/ConstWheel.html[ConstWheel]
...
|{url-api}/WheelSettingsTv.html[WheelSettingsTv] +
 {url-api}/readonly/ConstWheelSettingsTv.html[ConstWheelSettingsTv] +
...
|{url-api}/WheelSettingsWv.html[WheelSettingsWv] +
 {url-api}/readonly/ConstWheelSettingsWv.html[ConstWheelSettingsWv] +
...
|{url-api}/WheeledVehicleControllerSettings.html[WheeledVehicleControllerSettings] +
 {url-api}/readonly/ConstWheeledVehicleControllerSettings.html[ConstWheeledVehicleControllerSettings]
