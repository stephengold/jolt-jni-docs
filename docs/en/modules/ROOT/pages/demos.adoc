...
* {url-examples}/HairDemo.java[`HairDemo`]
  demonstrates hair simulation +
  image:hairDemo.png[height=50]
...
* `HairDemo`, `NewtonsCradle`, `Pachinko`, and `Windlass`
   use `DragLMB` rotation mode.
