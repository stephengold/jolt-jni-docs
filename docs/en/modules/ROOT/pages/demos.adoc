...
** kbd:[W] pushes the marble away from the viewer,
** kbd:[S] pushes the marble towards the viewer,
** kbd:[A] push the marble to the viewer's left, and
** kbd:[D] pushes the marble to the viewer's right.
