...
Both shapes and shape settings are refcounted objects.
...
{JPH} rounds off edges and corners.
...
The resulting shape is typically far more efficient for simulation
...
* For moving bodies,
  ...
  such as triangles or convex hulls.
